...
-----
  ...
  β_τ = coefficient of interest      (one per quarter, ~37 total)
...
-------------------------------
  ...
  - 2020 included but COVID flag added for robustness checks

OUTPUTS
-------
  results/event_study_log_emp.csv      coefficient table, employment
  results/event_study_log_wage.csv     coefficient table, wages
  results/event_study_log_wbill.csv    coefficient table, wage bill
  results/event_study_log_emp.png      event study plot, employment
  results/event_study_log_wage.png     event study plot, wages
  results/event_study_log_wbill.png    event study plot, wage bill
================================================================================
"""
...
# COVID period flag (2020Q1–2021Q2) — kept in sample, flagged for robustness
COVID_START = (-9,)   # τ = -9 = 2020Q3 (approximate)
...
def plot_event_study(
    ...
    Layout:
      ...
      - COVID period shaded orange (2020–2021)
    ...
    # COVID shading (approximate: 2020Q1 = τ≈-11 to 2021Q4 = τ≈-4)
    ax.axvspan(
        -11.5, -3.5,
        alpha=0.15, color=PLOT_STYLE["covid_shade"],
        label="COVID period (2020–2021)", zorder=0
    )
    ...
    fig.text(
        ...
        "Shaded band = 95% CI. Orange shading = COVID period. "
...
def main() -> None:
    ...
    for outcome, label in OUTCOMES.items():
        ...
        csv_path = RESULTS_DIR / f"event_study_{outcome}.csv"
        ...
        # Plot
        png_path = RESULTS_DIR / f"event_study_{outcome}.png"
...
COVID period (orange shading, 2020–2021):
  Expect large swings — Leisure/Hospitality crushed, Finance/Info stable
  These quarters are NOT part of your causal story; note in paper

ROBUSTNESS CHECKS TO RUN NEXT:
  1. Drop 2020–2021 entirely, re-estimate
