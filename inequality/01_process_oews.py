...
-------------------------------------------------
  ...
  (percentile data follows the same suppression)

OUTPUTS
-------
  data/processed/oews_national_panel.csv   ← now includes wage percentile columns
...
----------------------------------------------------------------------
  ...
  a_pct10          10th percentile annual wage (NaN if suppressed)
  a_pct25          25th percentile annual wage (NaN if suppressed)
  a_median          50th percentile annual wage / median
  a_pct75          75th percentile annual wage (NaN if suppressed)
  a_pct90          90th percentile annual wage (NaN if suppressed)
================================================================================
"""
